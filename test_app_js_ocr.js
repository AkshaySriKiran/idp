...
CRITICAL: If the page is clearly a Table of Contents or Index with no actual parts/maintenance data, return exactly: {"maintenance": [], "spare_parts": []}. CRITICAL EXCEPTION: Do NOT return empty arrays if you see actual part names accompanied by alphanumeric codes (e.g., 'PCB114C Amplifier', 'a. Part Name', etc.), even if the text contains chapter numbers like '10.01'. If specific parts exist, you MUST extract them regardless of the surrounding layout.
